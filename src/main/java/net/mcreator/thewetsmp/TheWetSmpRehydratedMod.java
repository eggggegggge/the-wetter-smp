 ...
 *
 *    Keep the TheWetSmpRehydratedModElements object in this class and all calls to this object
...
public class TheWetSmpRehydratedMod {
	...
	public TheWetSmpRehydratedMod() {
		...
		MinecraftForge.EVENT_BUS.register(new TheWetSmpRehydratedModFMLBusEvents(this));
	}
