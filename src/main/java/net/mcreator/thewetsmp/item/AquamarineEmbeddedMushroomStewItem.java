...
public class AquamarineEmbeddedMushroomStewItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:aquamarine_embedded_mushroom_stew")
	public static final Item block = null;
	public AquamarineEmbeddedMushroomStewItem(TheWetSmpModElements instance) {
		super(instance, 41);
	}
