...
public class PinkJellyfishItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:pink_jellyfish")
	public static final Item block = null;
	public PinkJellyfishItem(TheWetSmpModElements instance) {
		super(instance, 349);
	}
