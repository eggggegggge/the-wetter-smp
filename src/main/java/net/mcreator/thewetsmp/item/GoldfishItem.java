...
public class GoldfishItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:goldfish")
	public static final Item block = null;
	public GoldfishItem(TheWetSmpModElements instance) {
		super(instance, 329);
	}
