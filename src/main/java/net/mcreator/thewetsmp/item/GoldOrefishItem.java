...
public class GoldOrefishItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:gold_orefish")
	public static final Item block = null;
	public GoldOrefishItem(TheWetSmpModElements instance) {
		super(instance, 385);
	}
