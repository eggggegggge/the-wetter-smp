...
public class OnyxEmbeddedBeetrootSoupItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:onyx_embedded_beetroot_soup")
	public static final Item block = null;
	public OnyxEmbeddedBeetrootSoupItem(TheWetSmpModElements instance) {
		super(instance, 93);
	}
