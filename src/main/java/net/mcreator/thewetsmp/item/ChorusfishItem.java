...
public class ChorusfishItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:chorusfish")
	public static final Item block = null;
	public ChorusfishItem(TheWetSmpModElements instance) {
		super(instance, 352);
	}
