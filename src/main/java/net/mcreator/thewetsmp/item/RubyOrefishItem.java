...
public class RubyOrefishItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:ruby_orefish")
	public static final Item block = null;
	public RubyOrefishItem(TheWetSmpModElements instance) {
		super(instance, 383);
	}
