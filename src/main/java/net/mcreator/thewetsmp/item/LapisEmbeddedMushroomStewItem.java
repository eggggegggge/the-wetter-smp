...
public class LapisEmbeddedMushroomStewItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:lapis_embedded_mushroom_stew")
	public static final Item block = null;
	public LapisEmbeddedMushroomStewItem(TheWetSmpModElements instance) {
		super(instance, 85);
	}
