...
public class LapisEmbeddedMushroomStewItem extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lapis_embedded_mushroom_stew")
	public static final Item block = null;

	public LapisEmbeddedMushroomStewItem(TheWetSmpRehydratedModElements instance) {
		super(instance, 47);
	}
		...
		public FoodItemCustom() {
			super(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(1).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(6).saturation(7.2f)
							...
							.build()));
			setRegistryName("lapis_embedded_mushroom_stew");
		}
