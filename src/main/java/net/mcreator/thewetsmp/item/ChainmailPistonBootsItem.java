...
public class ChainmailPistonBootsItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:chainmail_piston_helmet")
	public static final Item helmet = null;
	@ObjectHolder("the_wet_smp:chainmail_piston_chestplate")
	public static final Item body = null;
	@ObjectHolder("the_wet_smp:chainmail_piston_leggings")
	public static final Item legs = null;
	@ObjectHolder("the_wet_smp:chainmail_piston_boots")
	public static final Item boots = null;
	public ChainmailPistonBootsItem(TheWetSmpModElements instance) {
		super(instance, 30);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.FEET, new Item.Properties().group(ItemGroup.TRANSPORTATION)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "the_wet_smp:textures/models/armor/chainmail_piston_boots_armour__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1")
						+ ".png";
			}
