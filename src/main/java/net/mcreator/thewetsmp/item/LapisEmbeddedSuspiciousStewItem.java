...
public class LapisEmbeddedSuspiciousStewItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:lapis_embedded_suspicious_stew")
	public static final Item block = null;
	public LapisEmbeddedSuspiciousStewItem(TheWetSmpModElements instance) {
		super(instance, 118);
	}
