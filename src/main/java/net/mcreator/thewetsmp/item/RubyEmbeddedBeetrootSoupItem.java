...
public class RubyEmbeddedBeetrootSoupItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:ruby_embedded_beetroot_soup")
	public static final Item block = null;
	public RubyEmbeddedBeetrootSoupItem(TheWetSmpModElements instance) {
		super(instance, 102);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("ruby_embedded_beetroot_soup");
		}
