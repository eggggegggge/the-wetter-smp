...
public class EmeraldEmbeddedRabbitStewItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:emerald_embedded_rabbit_stew")
	public static final Item block = null;
	public EmeraldEmbeddedRabbitStewItem(TheWetSmpModElements instance) {
		super(instance, 77);
	}
