...
public class RedJellyfishItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:red_jellyfish")
	public static final Item block = null;
	public RedJellyfishItem(TheWetSmpModElements instance) {
		super(instance, 335);
	}
