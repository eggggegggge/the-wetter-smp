...
public class OnyxOrefishItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:onyx_orefish")
	public static final Item block = null;
	public OnyxOrefishItem(TheWetSmpModElements instance) {
		super(instance, 386);
	}
