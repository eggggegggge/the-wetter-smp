...
public class RubyEmbeddedMushroomStewItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:ruby_embedded_mushroom_stew")
	public static final Item block = null;
	public RubyEmbeddedMushroomStewItem(TheWetSmpModElements instance) {
		super(instance, 103);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("ruby_embedded_mushroom_stew");
		}
