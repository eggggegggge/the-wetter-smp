...
public class OnyxEmbeddedRabbitStewItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:onyx_embedded_rabbit_stew")
	public static final Item block = null;
	public OnyxEmbeddedRabbitStewItem(TheWetSmpModElements instance) {
		super(instance, 95);
	}
