...
public class NetherragfishItem extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:netherragfish")
	public static final Item block = null;
	public NetherragfishItem(TheWetSmpModElements instance) {
		super(instance, 378);
	}
