...
import net.mcreator.thewetsmp.world.features.ores.DeepslateOsmiumOreFeature;
...
public class TheWetSmpRehydratedModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(DeepslateOsmiumOreFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES,
				DeepslateOsmiumOreFeature.GENERATE_BIOMES, DeepslateOsmiumOreFeature.CONFIGURED_FEATURE));
	}
