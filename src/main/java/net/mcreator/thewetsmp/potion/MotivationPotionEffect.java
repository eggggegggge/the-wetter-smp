...
public class MotivationPotionEffect {
	@ObjectHolder("the_wet_smp:motivation")
	...
	public static class EffectCustom extends Effect {
		...
		public EffectCustom() {
			...
			potionIcon = new ResourceLocation("the_wet_smp:textures/motivation.png");
		}
		...
		public void applyAttributesModifiersToEntity(LivingEntity entity, AttributeModifierManager attributeMapIn, int amplifier) {
			...
			double z = entity.getPosZ();
			{
				...
				MotivationStartProcedureProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void removeAttributesModifiersFromEntity(LivingEntity entity, AttributeModifierManager attributeMapIn, int amplifier) {
			...
			double z = entity.getPosZ();
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				MotivationExpireProcedureProcedure.executeProcedure($_dependencies);
			}
		}
