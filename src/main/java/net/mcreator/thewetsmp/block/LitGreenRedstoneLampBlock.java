...
public class LitGreenRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_green_redstone_lamp")
	public static final Block block = null;
	public LitGreenRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 352);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(GreenRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GreenRedstoneLampBlock.block));
		}
