...
public class LitMagentaRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_magenta_redstone_lamp")
	public static final Block block = null;
	public LitMagentaRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 509);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(MagentaRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MagentaRedstoneLampBlock.block));
		}
