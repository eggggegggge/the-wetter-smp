...
public class LitYellowRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_yellow_redstone_lamp")
	public static final Block block = null;
	public LitYellowRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 350);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(YellowRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(YellowRedstoneLampBlock.block));
		}
