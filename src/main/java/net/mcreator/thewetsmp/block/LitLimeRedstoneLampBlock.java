...
public class LitLimeRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_lime_redstone_lamp")
	public static final Block block = null;
	public LitLimeRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 503);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(LimeRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LimeRedstoneLampBlock.block));
		}
