...
public class LitBlackRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_black_redstone_lamp")
	public static final Block block = null;

	public LitBlackRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 362);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(BlackRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BlackRedstoneLampBlock.block));
		}
