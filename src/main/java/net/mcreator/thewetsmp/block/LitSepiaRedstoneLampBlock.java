...
public class LitSepiaRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_sepia_redstone_lamp")
	public static final Block block = null;
	public LitSepiaRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 516);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lit_sepia_redstone_lamp");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(SepiaRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SepiaRedstoneLampBlock.block));
		}
