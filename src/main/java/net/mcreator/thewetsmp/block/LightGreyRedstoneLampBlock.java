...
public class LightGreyRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:light_grey_redstone_lamp")
	public static final Block block = null;
	public LightGreyRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 495);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("light_grey_redstone_lamp");
		}
