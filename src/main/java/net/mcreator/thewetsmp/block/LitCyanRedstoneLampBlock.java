...
public class LitCyanRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_cyan_redstone_lamp")
	public static final Block block = null;

	public LitCyanRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 354);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(CyanRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CyanRedstoneLampBlock.block));
		}
