...
import net.mcreator.thewetsmp.procedures.ValidPlacementConditionProcedure;
import net.mcreator.thewetsmp.procedures.StungBySeaUrchinProcedureProcedure;
...
public class SeaUrchinBlock extends TheWetSmpRehydratedModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(FishingItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
