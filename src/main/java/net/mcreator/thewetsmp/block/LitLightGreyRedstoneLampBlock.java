...
public class LitLightGreyRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_light_grey_redstone_lamp")
	public static final Block block = null;

	public LitLightGreyRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 360);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lit_light_grey_redstone_lamp");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(LightGreyRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LightGreyRedstoneLampBlock.block));
		}
