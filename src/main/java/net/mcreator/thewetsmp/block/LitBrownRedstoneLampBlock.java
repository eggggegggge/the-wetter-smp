...
public class LitBrownRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_brown_redstone_lamp")
	public static final Block block = null;
	public LitBrownRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 363);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(BrownRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BrownRedstoneLampBlock.block));
		}
