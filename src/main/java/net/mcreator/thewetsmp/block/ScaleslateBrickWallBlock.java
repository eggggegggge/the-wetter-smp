...
public class ScaleslateBrickWallBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:scaleslate_brick_wall")
	public static final Block block = null;

	public ScaleslateBrickWallBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 597);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("scaleslate_brick_wall");
		}
