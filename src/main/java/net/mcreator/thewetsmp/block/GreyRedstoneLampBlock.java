...
public class GreyRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:grey_redstone_lamp")
	public static final Block block = null;
	public GreyRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("grey_redstone_lamp");
		}
