...
public class LitLightBlueRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_light_blue_redstone_lamp")
	public static final Block block = null;
	public LitLightBlueRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 353);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(LightBlueRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LightBlueRedstoneLampBlock.block));
		}
