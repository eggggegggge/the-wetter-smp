...
public class CobbledScaleslateWallBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:cobbled_scaleslate_wall")
	public static final Block block = null;

	public CobbledScaleslateWallBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 589);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("cobbled_scaleslate_wall");
		}
