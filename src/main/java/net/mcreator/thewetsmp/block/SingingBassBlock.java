...
public class SingingBassBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:singing_bass")
	public static final Block block = null;
	public SingingBassBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 158);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				RightClickSingingBassProcedureProcedure.executeProcedure($_dependencies);
			}
