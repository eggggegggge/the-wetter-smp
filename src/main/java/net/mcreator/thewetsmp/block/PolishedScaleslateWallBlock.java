...
public class PolishedScaleslateWallBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:polished_scaleslate_wall")
	public static final Block block = null;

	public PolishedScaleslateWallBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 593);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_scaleslate_wall");
		}
