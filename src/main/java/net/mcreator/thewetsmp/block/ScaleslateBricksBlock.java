...
public class ScaleslateBricksBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:scaleslate_bricks")
	public static final Block block = null;

	public ScaleslateBricksBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 594);
	}
