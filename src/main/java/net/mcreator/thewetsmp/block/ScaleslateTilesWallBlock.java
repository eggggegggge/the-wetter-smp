...
public class ScaleslateTilesWallBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:scaleslate_tiles_wall")
	public static final Block block = null;

	public ScaleslateTilesWallBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 601);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("scaleslate_tiles_wall");
		}
