...
public class LitWhiteRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_white_redstone_lamp")
	public static final Block block = null;

	public LitWhiteRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 359);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(WhiteRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(WhiteRedstoneLampBlock.block));
		}
