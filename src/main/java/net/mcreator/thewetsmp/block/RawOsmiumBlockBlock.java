...
public class RawOsmiumBlockBlock extends TheWetSmpModElements.ModElement {
	@ObjectHolder("the_wet_smp:raw_osmium_block")
	public static final Block block = null;
	public RawOsmiumBlockBlock(TheWetSmpModElements instance) {
		super(instance, 355);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("raw_osmium_block");
		}
