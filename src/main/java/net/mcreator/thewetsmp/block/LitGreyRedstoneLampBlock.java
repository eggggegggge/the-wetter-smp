...
public class LitGreyRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_grey_redstone_lamp")
	public static final Block block = null;

	public LitGreyRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 361);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lit_grey_redstone_lamp");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(GreyRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GreyRedstoneLampBlock.block));
		}
