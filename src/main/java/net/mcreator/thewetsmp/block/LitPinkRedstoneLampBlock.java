...
public class LitPinkRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_pink_redstone_lamp")
	public static final Block block = null;

	public LitPinkRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 358);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(PinkRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PinkRedstoneLampBlock.block));
		}
