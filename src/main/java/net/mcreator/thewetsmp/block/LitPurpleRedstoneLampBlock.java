...
public class LitPurpleRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_purple_redstone_lamp")
	public static final Block block = null;
	public LitPurpleRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 508);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(PurpleRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PurpleRedstoneLampBlock.block));
		}
