...
public class LitOrangeRedstoneLampBlock extends TheWetSmpRehydratedModElements.ModElement {
	@ObjectHolder("the_wet_smp_rehydrated:lit_orange_redstone_lamp")
	public static final Block block = null;
	public LitOrangeRedstoneLampBlock(TheWetSmpRehydratedModElements instance) {
		super(instance, 501);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(OrangeRedstoneLampBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(OrangeRedstoneLampBlock.block));
		}
