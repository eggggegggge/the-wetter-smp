...
@OnlyIn(Dist.CLIENT)
public class AquamarineGrapplingHookRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(AquamarineGrapplingHookItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}
	...
	public static class CustomRender extends EntityRenderer<AquamarineGrapplingHookItem.ArrowCustomEntity> {
		...
		@Override
		public void render(AquamarineGrapplingHookItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(AquamarineGrapplingHookItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
