...
@OnlyIn(Dist.CLIENT)
public class ExplosiveCrabCannonRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ExplosiveCrabCannonItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}
	...
	public static class CustomRender extends EntityRenderer<ExplosiveCrabCannonItem.ArrowCustomEntity> {
		...
		@Override
		public void render(ExplosiveCrabCannonItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(ExplosiveCrabCannonItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
