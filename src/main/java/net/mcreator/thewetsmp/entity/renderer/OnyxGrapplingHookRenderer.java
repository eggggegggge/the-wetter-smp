...
@OnlyIn(Dist.CLIENT)
public class OnyxGrapplingHookRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(OnyxGrapplingHookItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}
	...
	public static class CustomRender extends EntityRenderer<OnyxGrapplingHookItem.ArrowCustomEntity> {
		...
		@Override
		public void render(OnyxGrapplingHookItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(OnyxGrapplingHookItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
