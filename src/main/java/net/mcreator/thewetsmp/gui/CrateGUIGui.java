...
package net.mcreator.thewetsmp.gui;
...
public class CrateGUIGui extends TheWetSmpRehydratedModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CrateGUIGui(TheWetSmpRehydratedModElements instance) {
		super(instance, 501);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 7, 17) {
			}));
			this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 25, 17) {
			}));
			this.customSlots.put(11, this.addSlot(new SlotItemHandler(internal, 11, 43, 17) {
			}));
			this.customSlots.put(12, this.addSlot(new SlotItemHandler(internal, 12, 61, 17) {
			}));
			this.customSlots.put(13, this.addSlot(new SlotItemHandler(internal, 13, 79, 17) {
			}));
			this.customSlots.put(14, this.addSlot(new SlotItemHandler(internal, 14, 97, 17) {
			}));
			this.customSlots.put(15, this.addSlot(new SlotItemHandler(internal, 15, 115, 17) {
			}));
			this.customSlots.put(16, this.addSlot(new SlotItemHandler(internal, 16, 133, 17) {
			}));
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				TheWetSmpRehydratedMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
